...
// VOCABULARY
let str = () => {
    const value = "  Serhat ecmascript öğreniyor.";
    return value;
}
...
// 1- ES5(2009) "use strict"; => Katı mod 

// 2- ES5(2009) String Access  => charAt yerine kullanıyoruz
...
const JsonFunction = () => {
    ...
    let stringData = JSON.stringify(data); // object to string
